...
#define ENCODER_ROTATION_DEBOUNCE_CW 12  // milliseconds for clockwise rotation
#define ENCODER_ROTATION_DEBOUNCE_CCW 8 // milliseconds for counter-clockwise rotation
