...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (32 * 1024U)          /*[bytes] - REDUCED from 64K to 32K*/
...
#define LV_DRAW_LAYER_SIMPLE_BUF_SIZE    (16 * 1024)   /*[bytes] - REDUCED from 24K to 16K*/

/* The stack size of the drawing thread.
 * NOTE: If FreeType or ThorVG is enabled, it is recommended to set it to 32KB or more.
 */
#define LV_DRAW_THREAD_STACK_SIZE    (4 * 1024)   /*[bytes] - REDUCED from 8K to 4K*/
...
#define LV_FONT_MONTSERRAT_14 1  /* Keep this for default font */
#define LV_FONT_MONTSERRAT_16 0
#define LV_FONT_MONTSERRAT_18 1  /* CHANGED back to 1 for FONT_S */
#define LV_FONT_MONTSERRAT_20 0
#define LV_FONT_MONTSERRAT_22 0
#define LV_FONT_MONTSERRAT_24 1  /* CHANGED back to 1 for FONT_L */
...
#define LV_USE_ARC        0  /* CHANGED from 1 to 0 */
...
#define LV_USE_KEYBOARD   0  /* CHANGED from 1 to 0 */
...
#define LV_USE_LED        0  /* CHANGED from 1 to 0 */

#define LV_USE_LINE       1

#define LV_USE_LIST       0  /* CHANGED from 1 to 0 */
...
#define LV_USE_SPAN       0  /* CHANGED from 1 to 0 */
#if LV_USE_SPAN
    /*A line text can contain maximum num of span descriptor */
    #define LV_SPAN_SNIPPET_STACK_SIZE 64
#endif

#define LV_USE_SPINBOX    0  /* CHANGED from 1 to 0 */

#define LV_USE_SPINNER    0  /* CHANGED from 1 to 0 */
...
#define LV_USE_WIN        0  /* CHANGED from 1 to 0 */
...
#define LV_BUILD_EXAMPLES 0  /* CHANGED from 1 to 0 */
